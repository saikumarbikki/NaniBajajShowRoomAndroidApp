...
public class ContactUsFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView nani_Contact_us_email = view.findViewById(R.id.contact_us_email_IV);

        //Contact1 information
        contact1_Phone = view.findViewById(R.id.contactus_phone_showrooms_tv);
        ImageView contact1_Phone_Icon = view.findViewById(R.id.contactus_phone_showrooms_phone_icon);
        ImageView Contact1_sms_icon = view.findViewById(R.id.contactus_phone_showrooms_SMS_icon);

        //Contact2 information
        contact2_Phone = view.findViewById(R.id.contactus_phone_daddy_tv);
        ImageView contact2_Phone_Icon = view.findViewById(R.id.contactus_phone_daddy_icon);
        ImageView Contact2_sms_icon = view.findViewById(R.id.contactus_daddy_SMS_icon);

        //Contact3 information
        contact3_Phone = view.findViewById(R.id.contactus_phone_showroom_1_tv);
        ImageView contact3_Phone_Icon = view.findViewById(R.id.contactus_phone_showroom_1_phone_icon);
        ImageView Contact3_sms_icon = view.findViewById(R.id.contactus_phone_showroom_1_SMS_icon);

        //Contact4 information
        contact4_Phone = view.findViewById(R.id.contactus_phone_showroom_2_tv);
        ImageView contact4_Phone_Icon = view.findViewById(R.id.contactus_phone_showroom_2_phone_icon);
        ImageView Contact4_sms_icon = view.findViewById(R.id.contactus_phone_showroom_2_SMS_icon);
